...
private fun AuthTutorialOverlay(
    ...
    val tutorialSteps = listOf(
        TutorialStep(
            ...
            description = "A safe, inclusive space designed for neurodivergent minds. Let's show you around!",
            emoji = "✨",
        ...
        TutorialStep(
            ...
            description = "Sign in or create an account to join our community. Remember, this is YOUR safe space.",
            emoji = "🚀",
            showRainbowInfinity = false
        )
    )
