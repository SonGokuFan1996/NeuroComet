...
/**
 * Production-ready notification channels for NeuroNet.
 *
    ...
    private fun createAppChannels(notificationManager: NotificationManager) {
        ...
        val channels = listOf(
            ...
            NotificationChannel(
                ...
                description = "Helpful tips for using NeuroNet"
                group = GROUP_APP
                enableVibration(false)
                setShowBadge(false)
            }
...
object NotificationTester {
    ...
    val allTestNotifications: List<TestNotificationConfig> = listOf(
        ...
        TestNotificationConfig(
            ...
            content = "NeuroNet v1.1.0 is ready to install with new features!",
            priority = NotificationCompat.PRIORITY_DEFAULT,
            category = NotificationCompat.CATEGORY_SYSTEM,
            groupKey = "app"
        ),
