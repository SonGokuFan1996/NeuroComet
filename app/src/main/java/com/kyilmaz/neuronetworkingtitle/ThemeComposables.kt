...
/**
 * Neurodivergent-friendly theming engine for the NeuroNet application.
 *
 * This file contains:
...
fun NeuroThemeApplication(
    ...
    var colorScheme: ColorScheme = when {
        ...
        themeState.colorSchemeSource == com.kyilmaz.neuronetworkingtitle.ui.theme.ColorSchemeSource.DYNAMIC &&
